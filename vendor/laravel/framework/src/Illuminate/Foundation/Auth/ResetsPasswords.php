...
trait ResetsPasswords
{
    ...
    public function showLinkRequestForm()
    {
        if (property_exists($this, 'linkRequestView')) {
            return Theme::view($this->linkRequestView);
        }
    ...
    public function showResetForm(Request $request, $token = null)
    {
        ...
        if (property_exists($this, 'resetView')) {
            return Theme::view($this->resetView)->with(compact('token', 'email'));
        }

        if (view()->exists('auth.passwords.reset')) {
            return Theme::view('auth.passwords.reset')->with(compact('token', 'email'));
        }

        return Theme::view('auth.reset')->with(compact('token', 'email'));
    }
