...
@section('meta-title', trans('admin.settings'))
            ...
            <div class="col-md-9">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            {!! Form::label('post_bottom_scripts',  trans('admin.addcode')) !!}
