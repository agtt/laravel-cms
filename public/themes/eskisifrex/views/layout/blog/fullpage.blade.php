	...
	<header id="main-header" class="clearfix">
        <div id="header-full" class="clearfix">
            <div id="header" class="clearfix">
                ...
                <a href="/" id="logo"><img src="{{ Theme::asset('sifrex::img/logo.png') }}" data-retina="{{ Theme::asset('sifrex::img/logo-retina.png') }}" alt="" /></a>
    ...
    <footer id="main-footer" style="background:url({{ Theme::asset('sifrex::img/img-8.jpg') }}) no-repeat 50% 0;">
                ...
                <div id="sidebar-footer-left" class="sidebar-footer">
                    <aside class="widget-container">
                        <div class="widget-wrapper clearfix">
                            ...
                            <ul>
                                <li><a href="#">Tercih Robotu</a></li>
                                <li><a href="#">Kısa Şifrelemeler</a></li>
                                <li><a href="#">Konu Anlatımları</a></li>
        ...
        <div id="footer-copyright">
            <div id="footer-copyright-content" class="clearfix">
                ...
                <p id="text-copyright">Copyright &copy; 2016. Şifrex</p>
            </div>
        </div>
    </footer>
</body>
