...
<html lang="@yield('meta-lang', 'en')">
    <head>
        ...
        <link href="{{ Theme::asset('karesoft::css/karesoft.css') }}" rel="stylesheet">
        <?php /*<link href="{{ elixir('themes/karesoft/assets/css/blog.css') }}" rel="stylesheet">*/?>
       <?php /* <link href="{{ Theme::asset(elixir('themes/karesoft/assets/css/blog.css')) }}" rel="stylesheet">*/?>
    ...
    <body>
        @include(''.$theme.'::widgets.google_analytics')
        ...
        <script src="//maxcdn.bootstrapcdn.com/bootstrap/3.3.6/js/bootstrap.min.js"></script>
         <script src="{{ Theme::asset('karesoft::js/blog.js') }}"></script>
        @yield('scripts')
    </body>
</html>
