...
<html lang="en">
    <head>
        ...
        <title>@yield('meta-title', trans('admin.dashboard'))</title>
                    ...
                    <ul class="nav navbar-nav">
                         ...
                         <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                          <i class="fa fa-comment fa-fw"></i>
                            ...
                            <li>
                     <a class="{{ Request::is('admin/post/create*') ? 'active' : '' }}" href="{{ route('admin.post.create') }}"> {{trans('admin.addpost')}}</a>  </li>
                               <li>
                      <a class="{{ Request::is('admin/post*') ? 'active' : '' }}" href="{{ route('admin.post.index') }}">{{trans('admin.posts')}}</a></li>
                        <li>
                     <a class="{{ Request::is('admin/post/categories*') ? 'active' : '' }}" href="{{ route('admin.post.create') }}"> {{trans('admin.categories')}}</a>  </li>
                        ...
                        <li class="dropdown">
                         <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                             ...
                             <ul class="dropdown-menu">
                             <li><a class="{{ Request::is('admin/page*') ? 'active' : '' }}" href="{{ route('admin.page.create') }}">{{trans('admin.addpage')}}</a></li>
                              <li><a class="{{ Request::is('admin/page*') ? 'active' : '' }}" href="{{ route('admin.page.index') }}">{{trans('admin.pages')}}</a></li>
