                    ...
                    <div class="panel-heading">
                        ...
                        @foreach ($categories as $category)
                            <div class="checkbox">
                               ...
                               <br><label style="margin-left:10px;">{!! Form::checkbox('category_id[]', $sub->id, $post->categories->contains($sub->id)) !!} {{ $sub->name }}</label>
                                @endforeach
                                </label>
                            </div>
                        @endforeach
                ...
                <div class="panel panel-success">
                    ...
                    <div class="panel-body">
                        <div class="text-center">
                            ...
                            <div>
                                <a href="/{{ $post->slug }}" class="btn btn-info btn-xs" target="_blank">
                                    View Post
                                </a>
                            </div>
                        </div>
