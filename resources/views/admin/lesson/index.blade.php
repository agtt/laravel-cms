                        ...
                        <tr>
                            <td>
                                <a href="{{ route('admin.lesson.edit', $lesson->id) }}">
                                    {{ str_limit($lesson->title, 40) }}
                                </a>
                            </td>
                            <td><a href="lesson/{{ $lesson->id }}/create">Konu Ekle</a></td>
                            <td><a href="lesson/{{ $lesson->id }}/edit?subject=1">Konular(0)</a></td>
                            <td>
                                {{ $lesson->status }}
                            </td>
                            <td>
                            ...
                            <td>
                                 {{ $lesson->created_at->format('Y-m-d \a\t H:i:s') }}
                            </td>
                        </tr>
                    @endforeach
                </tbody>
